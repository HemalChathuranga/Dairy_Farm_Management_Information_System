...
class ManagerController extends Controller
{
    ...
    {
        $data['fetchedRecord'] = User::getManagerRec();
        $data['headerTitle'] = 'Manager List';
        return view('admin.manager.list', $data);
    ...
    {
        $data['headerTitle'] = 'Add New Manager';
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/manager/list')->with('success', 'Manager User Created Succesfully');
    ...
    public function show(string $id)
    {
        ...
        if (!empty($data['fetchedRecord'])) {
            ...
            $data['headerTitle'] = 'Manager User Info.';
    ...
    public function edit(string $id)
    {
        ...
        if (!empty($data['fetchedRecord'])) {
            ...
            $data['headerTitle'] = 'Edit Manager User Info.';
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin/manager/list')->with('success', 'Manager User Updated Succesfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('admin/manager/list')->with('success', 'Manager User Deleted Succesfully');
    }
}
