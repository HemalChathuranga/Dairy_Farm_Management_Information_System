                ...
                <div class="card-body"> 
                  <div class="row">
                    ...
                    <div class="form-group col-md-5">
                      ...
                      <a href="{{ url('fieldStaff/milkParlor/qr-scanner') }}" type="button" class="btn btn-primary" style="margin-top: 32px">Scan Ear Tag</a>
                      <a href="{{ url('fieldStaff/milkParlor/add_milking_queue/reset') }}" class="btn btn-warning" style="margin-top: 32px" onclick="return confirm('Warning..! \nReseting the Milking Queue will wipe all the existing details in the current Queue.')">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
                  ...
                  <form action="/fieldStaff/milkParlor/add_milking_queue/save" method="POST">
                    @csrf
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-8">
                            ...
                            <tbody>
                              @foreach ($fetchedRecord as $item)
                                ...
                                <tr>
                                  ...
                                  <td><a href="{{ url('fieldStaff/milkParlor/add_milking_queue/'.$item->id.'/delete') }}" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to Remove this Animal form the Milking Queue?')"> Remove</a></td>
                                </tr>
