...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="nav-icon fas fa-user-tie"></i> Office Staff List</h1>
          </div>
          <div class="col-sm-6">
            @include('message')
          </div>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('manager/officeStaff/list') }}" class="btn btn-warning" style="margin-top: 32px">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="card-header">
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <div>
                      <a href="{{ url('manager/officeStaff/add') }}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Add Staff</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach ($fetchedRecord as $item)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('manager/officeStaff/'.$item->id.'/view') }}" type="button" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></a>
                          <a href="{{ url('manager/officeStaff/'.$item->id.'/edit') }}" type="button" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a>
                          {{-- User Delete Functionality removed from the Manager role and only kept at the Admin level --}}
                          {{-- <a href="{{ url('manager/officeStaff/'.$item->id.'/delete') }}" type="button" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Record?')">Delete</a> --}}
                        </td>
                      </tr>
                  @endforeach
                  </tbody>
