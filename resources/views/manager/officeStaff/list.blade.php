                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach ($fetchedRecord as $item)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('manager/officeStaff/'.$item->id.'/view') }}" type="button" class="btn btn-outline-info">View</a>
                          <a href="{{ url('manager/officeStaff/'.$item->id.'/edit') }}" type="button" class="btn btn-outline-warning">Edit</a>
                          {{-- User Delete Functionality removed from the Manager role and only kept at the Admin level --}}
                          {{-- <a href="{{ url('manager/officeStaff/'.$item->id.'/delete') }}" type="button" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this Record?')">Delete</a> --}}
                        </td>
                      </tr>
                  @endforeach
                  </tbody>
