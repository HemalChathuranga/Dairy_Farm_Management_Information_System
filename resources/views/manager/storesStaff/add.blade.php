                ...
                <div class="card-body">
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" name="emp_id" id="emp_id" value="{{ old('emp_id') }}" placeholder="Enter Employee ID">
              <div style="color: rgb(196, 3, 3)">{{ $errors->first('emp_id') }}</div>
						</div>
            <div class="form-group col-md-6">
