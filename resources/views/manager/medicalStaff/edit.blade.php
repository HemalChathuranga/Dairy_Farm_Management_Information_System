      ...
      <div class="container-fluid">
        <div class="row">
                ...
                <div class="card-header">
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 150px;">
                        <div>
                          <a href="{{ url('manager/medicalStaff/list') }}" class="btn btn-primary float-end"><i class="fas fa-backward"></i> Back</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" name="emp_id" id="emp_id" value="{{ old('emp_id', $fetchedRecord->emp_id) }}" placeholder="Enter Employee ID" readonly>
						</div>
            <div class="form-group col-md-6">
          ...
          <div class="row">
              ...
              <textarea class="form-control" name="address" id="address" rows="4" value="{{ old('address', $fetchedRecord->address) }}" placeholder="Enter Address">{{ $fetchedRecord->address }}</textarea>
						</div>
					</div>
          <div class="row">
						<div class="form-group col-md-6">
              ...
              <p style="color: darkgrey">Add a password only if you wish to update the password</p>
						</div>
						<div class="form-group col-md-6">
