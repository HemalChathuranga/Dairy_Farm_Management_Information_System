                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('manager/medicalStaff/list') }}" class="btn btn-warning" style="margin-top: 32px">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="card-header">
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <div>
                      <a href="{{ url('manager/medicalStaff/add') }}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Add Staff</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach ($fetchedRecord as $item)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('manager/medicalStaff/'.$item->id.'/view') }}" type="button" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></a>
                          <a href="{{ url('manager/medicalStaff/'.$item->id.'/edit') }}" type="button" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a>
                          {{-- User Delete Functionality removed from the Manager role and only kept at the Admin level --}}
                          {{-- <a href="{{ url('manager/medicalStaff/'.$item->id.'/delete') }}" type="button" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Record?')">Delete</a> --}}
                        </td>
                      </tr>
                  @endforeach
                  </tbody>
