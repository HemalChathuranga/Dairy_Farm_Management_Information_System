...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="nav-icon fas fa-file-medical"></i> Mark Delivery Details</h1>
          </div>
                ...
                <div class="card-body">
                  <div class="row mt-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="date" class="form-control" name="preg_date" id="preg_date" value="{{ old('preg_date', $fetchedRecord->preg_date) }}" readonly>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="date" class="form-control" name="estimated_delivery_date" id="estimated_delivery_date" value="{{ old('estimated_delivery_date',  $fetchedRecord->estimated_delivery_date) }}" readonly>
                      <div style="color: rgb(196, 3, 3)">{{ $errors->first('estimated_delivery_date') }}</div>
                    </div>
                    <div class="form-group col-md-3">
                      <label for="actual_delivery_date">Actual Delivery Date <span style="color: red">*</span></label>
                      <input type="date" class="form-control" name="actual_delivery_date" id="actual_delivery_date" value="{{ old('actual_delivery_date') }}">
                      <div style="color: rgb(196, 3, 3)">{{ $errors->first('actual_delivery_date') }}</div>
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                    <button type="submit" class="btn btn-success">Mark Delivery</button>
                </div>
              </form>
            </div>
          </div>
