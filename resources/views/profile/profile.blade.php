                ...
                <div class="card-header">
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 150px;">
                        <div>
                          <a href="{{ url('admin/change_password') }}" class="btn btn-primary float-end">Change Password</a>
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <img src="{{ '\uploads\profile_img\\' . $fetchedRecord->prof_pic }}" class="img-fluid d-block mx-auto" style="width:50%; hight:60%; align:center" alt="User Image">
                              <div class="row mt-1">
                                <div class="col d-flex justify-content-center">
                                  <a href="{{ url('admin/change_prof_pic') }}" class="btn btn-outline-secondary btn-sm">Change <i class="fas fa-camera-retro"></i></a>
                                </div>  
                              </div>
                          </div>
                        </div>
