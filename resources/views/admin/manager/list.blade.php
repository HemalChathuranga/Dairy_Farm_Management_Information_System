                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach ($fetchedRecord as $item)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('admin/manager/'.$item->id.'/view') }}" type="button" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></a>
                          <a href="{{ url('admin/manager/'.$item->id.'/edit') }}" type="button" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a>
                          <a href="{{ url('admin/manager/'.$item->id.'/delete') }}" type="button" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Record?')"><i class="fas fa-trash"></i></a>
                        </td>
                      </tr>
                  @endforeach
                  </tbody>
