                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach ($fetchedRecord as $item)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('admin/storesStaff/'.$item->id.'/view') }}" type="button" class="btn btn-outline-info">View</a>
                          <a href="{{ url('admin/storesStaff/'.$item->id.'/edit') }}" type="button" class="btn btn-outline-warning">Edit</a>
                          <a href="{{ url('admin/storesStaff/'.$item->id.'/delete') }}" type="button" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this Record?')">Delete</a>
                        </td>
                      </tr>
                  @endforeach
                  </tbody>
